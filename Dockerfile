...
COPY install-openbts-umts-from-source.sh /opt/install-openbts-umts-from-source.sh
RUN chmod +x /opt/install-openbts-umts-from-source.sh
RUN /opt/install-openbts-umts-from-source.sh

COPY default-config.sh /opt/default-config.sh
COPY simcards.csv /opt/simcards.csv
